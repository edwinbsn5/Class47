package class47.mainapp.network.constants;
...
public interface Constants {
    ...
    public static final String YOUTUBE_API_KEY = "AIzaSyAz8TvzJtYkvsNNRsQ345z2T9atm345QZOyc3OTk";
    ...
    public static final String BILLING_KEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAn6iTaSxTJ";

    public static final String WEB_SITE = "https://class47.com/";  //web site url address
    ...
    public static final String API_DOMAIN = "https://class47.com/";  // url address to which the application sends requests || http://10.0.2.2/ - for test on emulator in localhost [XAMPP]
