...
import class47.mainapp.network.adapter.MarketListAdapter;
import class47.mainapp.network.app.App;
import class47.mainapp.network.constants.Constants;
import class47.mainapp.network.model.MarketItem;
...
public class MarketFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == STREAM_NEW_POST && resultCode == getActivity().RESULT_OK && null != data) {
            ...
            if (App.getInstance().getInterstitialAdSettings().getInterstitialAdAfterNewMarketItem() != 0) {
