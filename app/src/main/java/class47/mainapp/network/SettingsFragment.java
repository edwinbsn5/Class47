...
public class SettingsFragment extends PreferenceFragment implements Constants {
    ...
    private Preference recentlyDeletedPreference, balancePreference, balanceHistoryPreference, logoutPreference, itemContactUs, aboutPreference, changePassword, itemServices, itemTerms, itemThanks, itemReferralsList, itemBlackList, itemNotifications, itemDeactivateAccount, itemPrivacy;
