...
import class47.mainapp.network.common.ActivityBase;
...
public class BalanceActivity extends ActivityBase {
    ...
    private static final String TAG = "mainapp.inappbilling";            // Here you can write anything you like! For example: obama.white.house.billing
    private static final String TOKEN = "mainapp.inappbilling";          // Here you can write anything you like! For example: obama.white.house.billing

    // See documentation!

    static final String ITEM_SKU_1 = "network.mainapp.class47.iap1";          // Change to: yourdomain.com.iap1
    static final String ITEM_SKU_2 = "network.mainapp.class47.iap2";          // Change to: yourdomain.com.iap2
    static final String ITEM_SKU_3 = "network.mainapp.class47.iap3";          // Change to: yourdomain.com.iap3
